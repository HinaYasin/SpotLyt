export default function Dashboard() {
  return (
    <div class="relative min-h-screen bg-gray-100 flex gap-2">
      <aside class="relative bg-gradient-to-br from-gray-800 to-gray-900 inset-0 -translate-x-80 fixed z-50 my-4 ml-4 h-[calc(100vh-32px)] w-72 rounded-xl transition-transform duration-300 xl:translate-x-0">
      ...
      <div class="p-4 m-2 w-10/12 inset-0">
        ...
        <div class="mt-12">
          <div class="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-2">
            ...
            <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md md:col-span-2 xl:col-span-1">
